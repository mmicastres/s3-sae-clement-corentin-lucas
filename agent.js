...
fetch(url, fetchOptions)
    ...
    .then((dataJSON) => { // dataJSON = les données renvoyées
        ...
        for (let i = 0; i < results.length; i++) {
            ...
            //A faire : ajouter une 3eme div centrale pour y mettre la description et abilitie afin qu'elle ne bouge pas et reste au centre
            ...
            <div class="col-9 d-flex align-items-center" id="right">
